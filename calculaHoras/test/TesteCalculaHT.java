...
import calculahoras.CalcularHorasTrabalhadas;
...
public class TesteCalculaHT {
    ...
    */
    ...
    public void calculaHTPeridoExtra50(){
        ...
        assertEquals(5.5f, HT.calcularHT(c1,c2), 0);
        
        //Entra as 06:00 sai as 12:00 = 7 horas        
        c1.set(2024, 3, 7,6, 0);
        c2.set(2024, 3, 7, 12, 0);
        assertEquals(7.0f, HT.calcularHT(c1,c2), 0);
        
        //Entra as 06:00 sai as 13:00 = 9,5   
        c1.set(2024, 3, 7,6, 0);
        c2.set(2024, 3, 7, 13, 0);
        assertEquals(9.5f, HT.calcularHT(c1,c2), 0);    
    }
    @Test
    public void calculaHTPeridoExtra100(){
        ...
        assertEquals(9.0f, HT.calcularHT(c1,c2), 0);
        
        //Entra as 00:00 sai as 09:00 =  17,5h
        c1.set(2024, 3, 7, 00, 0);
        c2.set(2024, 3, 7, 9, 0);
        assertEquals(17.5f, HT.calcularHT(c1,c2), 0);
        
        //Entra as 22:00 sai as 02:00 =  8h
        c1.set(2024, 3, 7, 22, 0);
        c2.set(2024, 3, 8, 2, 0);
        assertEquals(8.0f, HT.calcularHT(c1,c2), 0);  
        
        //Entra as 14:00 sai as 2:00 =  19,5h
        c1.set(2024, 3, 7, 14, 0);
        c2.set(2024, 3, 8, 2, 0);
        assertEquals(19.5f, HT.calcularHT(c1,c2), 0);
        
       //Entra 07/03 as 00:00 sai 09/03 as 00:00 =  35*2 + 1.5h = 36.5
        c1.set(2024, 3, 7, 00, 0);
        c2.set(2024, 3, 9, 00, 0);
        assertEquals(71.5f, HT.calcularHT(c1,c2), 0); 
    }        
